...
def test_api():
    ...
    # Print Library
    lib.lib_print()
    # Import all to libaray
    lib_all = Library(playlist_length=10, file_name="raw_tracks.csv", demo=False)
    print("Libirary Imported")
...
def time_api(argv):
    ...
    for search_incident in range(0, 1000):
        lib.lib_search(track_id=random.randint(0, 1172), print_data=False)
    end_time = time.time()
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 2:
        ...
        print("      Usage: python3 lab7_3.py [FIlE_NAME_ABBR]")
