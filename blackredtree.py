# Reference:
# https://github.com/stanislavkozlovski/Red-Black-Tree/blob/cb3cefb420bfa6c1d1fc703cefad54e209c7438c/rb_tree.py#L444
# https://github.com/LongAustin/Red-Black-Tree-Implementation/blob/master/rbtree.py
...
def test_api():
    ...
    lib = Library(playlist_length=10, file_name="raw_track_short_rd.csv", demo=True)
